...
const STANDARDS = [
  ...
  { id: 'auth-auth',      framework: 'SATRE',         short: 'Auth & Authz',        name: 'Authentication & Authorisation', tagline: null,                                                                          domains: ['access-identity'],             competencies: ['Authentication systems','Federated identity management','Role-based access control','Attribute-based access control','Least privilege implementation'] },
  { id: 'env-prov',       framework: 'SATRE',         short: 'Env. Provisioning',   name: 'Environment Provisioning',       tagline: null,                                                                          domains: ['technology-engineering'],      competencies: ['Secure environment design','Containerisation & orchestration','Cloud infrastructure management','Microservices & API design','Software development lifecycle'] },
  { id: 'data-ingress',   framework: 'SATRE',         short: 'Data Ingress/Egress', name: 'Data Ingestion & Egress',        tagline: null,                                                                          domains: ['data-management'],             competencies: ['Data pipeline development','Data validation','Data models & standardisation','Data quality management','Research dataset creation'] },
