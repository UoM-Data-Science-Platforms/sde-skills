...
=== ":material-battery-90: Senior Level"
    ...
    - Defines platform requirements and strategies for supporting standardized data models at scale
    - Leads initiatives to enhance platform interoperability and compliance with data model standards
    - Advises on risk, security, and governance considerations related to enabling standardized data models
