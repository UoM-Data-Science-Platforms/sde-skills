...
=== ":material-battery-10: Entry Level"
    ...
    - Configures user accounts in identity systems under supervision
    - Understands existing SDE security matrices.
    

=== ":material-battery-50: Mid Level"

    - Implements and configures secure authentication systems (e.g SDE security matrix, microsoft entra)
...
=== ":material-battery-90: Senior Level"
    ...
    - Consults on enterprise authentication strategies.
    ...
    - Leads and provide support for existing security matrices.   

### User Provisioning & Lifecycle

User Provisioning & Lifecycle is the management of the complete lifecycle of user accounts in within secure data environments, from creation to deactivation. This encompasses the designing and automating provisioning processes, ensuring compliance with management policies, and establishing governance frameworks that support efficient identity management across the organisation.

=== ":material-battery-10: Entry Level"

    - Understands user account lifecycle stages
    - Familiar with provisioning and deprovisioning processes
    - Executes standard account management tasks following established procedures
    - Understands existing user provisioning specification.  
...
=== ":material-battery-50: Mid Level"
    ...
    - Investigates/modifies/troubleshoots existing user provisioning specification queries

=== ":material-battery-90: Senior Level"

    - Appraises, select and implement appropriate user lifecycle governance frameworks
    - Implements advanced identity governance and administration solutions
    - Leads identity management modernization initiatives
    - Creates and leads new user provisioning specification implementation and support

### Federated Identity Management

Federated Identity Management enables secure authentication across organisational boundaries through single sign-on protocols like SAML, OAuth, and OIDC. This involves configuring and managing federation with multiple identity providers, troubleshooting security issues, and developing governance frameworks to enhance secure collaboration between healthcare organisations and research institutions.

=== ":material-battery-10: Entry Level"

    - Understands basic concepts of federated identity
    - Familiar with SSO protocols (SAML, OAuth, OIDC)
    - Configures simple federated identity integrations
...
=== ":material-battery-90: Senior Level"
    ...
    - Designs complex architecture for federated identity solutions across organisational boundaries
...
Access Control ensures that only authorised individuals can access specific resources within secure data environments through structured permission systems. This sub-domain covers role-based and attribute-based access models as well as least privilege implementation, providing robust security frameworks that enforce authorization policies while balancing operational requirements and minimizing access risks across research environments.

### Role-Based Access Control

Role-Based Access Control enables access permissions based on organizational roles within secure data environments. This involves defining appropriate roles, designing organisational role structures, implementing management processes, and conducting reviews. Requires skills to develop enterprise frameworks and optimise role structures to minimise access risks while meeting business needs.
...
=== ":material-battery-10: Entry Level"
    ...
    - Implements basic role assignments following established patterns
    - Understands existing role definitions
...
=== ":material-battery-50: Mid Level"
    ...
    - Modifies/troubleshoots/investigates role definition queries.
...
=== ":material-battery-90: Senior Level"
    ...
    - Leads new role definition implementation and support.  


### Attribute-Based Access Control

Attribute-Based Access Control is used to implement dynamic, context-aware access control using attributes rather than roles. This requires defining policies based on various attribute types, designing controls for different contexts, evaluating their effectiveness, developing advanced policy models for complex scenarios, and leading initiatives to implement dynamic access management across an organisation.

=== ":material-battery-10: Entry Level"

    - Understands ABAC concepts and use cases
    - Familiar with policy definition and attribute types
    - Implements simple attribute-based policies
...
=== ":material-battery-90: Senior Level"
    ...
    - Designs enterprise level architecture for Attribute-Based Access Control strategies and frameworks
...
=== ":material-battery-10: Entry Level"
    ...
    - Identifies excessive permissions in simple scenarios
    - Understands existing role-level security 
...
=== ":material-battery-10: Entry Level"
    ...
    - Executes onboarding steps following established procedures
...
=== ":material-battery-90: Senior Level"
    ...
    - Designs and develops cross-organisational onboarding strategies
    - Leads initiatives to enhance researcher experience and security

### Secure Research Workspaces

Secure Research Workspaces concerns creation and maintanance of protected environments for researchers working with sensitive data. This involves designing secure environments tailored to research needs, implementing isolation controls, troubleshooting issues, optimising user experience, eevaluating technologies and leading modernisation initiatives to enhance security while supporting research activities.

=== ":material-battery-10: Entry Level"

    - Understands secure workspace concepts and components
    - Familiar with workspace provisioning processes
    - Configures basic workspace settings following templates
    - Understands current Research workspace
...
=== ":material-battery-50: Mid Level"
    ...
    - Supports extant research workspaces including installing new software and applications, configuring existing applications, online services whitelisting
...
=== ":material-battery-50: Mid Level"
    ...
    - Supports/creates/maintains 'secrets' using cloud services.

=== ":material-battery-90: Senior Level"

    - Develops secure collaboration strategies across research environments
    - Leads implementation of change in repsonse to new guidance / governance frameworks and regulations for secure information sharing
    - Leads initiatives to enhance collaboration capabilities whilst maintaining security
